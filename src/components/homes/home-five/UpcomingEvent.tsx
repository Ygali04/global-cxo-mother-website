                        ...
                        <div className="upcoming-event-card" style={{
                            ...
                            <div className="row g-0 align-items-stretch">
                                <div className="col-lg-5">
                                    <div style={{ position: "relative", width: "100%", height: "100%", minHeight: "280px", overflow: "hidden" }}>
                                        {/* eslint-disable-next-line @next/next/no-img-element */}
                                        <img src="/events/mlc-oakland-1.jpg" alt="Major League Cricket — Season 04 Final"
                                            className="upcoming-event-img"
                                            style={{ width: "100%", height: "100%", objectFit: "cover", position: "absolute", inset: 0, transition: "transform 0.4s ease" }} />
                                    </div>
                                </div>
                                <div className="col-lg-7">
                                    <div style={{ padding: "clamp(28px, 4vw, 48px)", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                                        <span style={{
                                            background: "var(--tg-color-gradient)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
