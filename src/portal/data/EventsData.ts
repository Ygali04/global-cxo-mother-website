...
export const eventsData: EventDetail[] = [
  {
    ...
    attendees: '250+',
    heroImage: sfConferenceImages.banner,
    heroImageMobile: sfConferenceImages.card,
    cardImage: sfConferenceImages.card,
    bannerImage: sfConferenceImages.banner,
    gallery: [],
    overview: 'The CIO 100 Awards & Conference celebrates 100 organizations and the teams within them that are using IT in innovative ways to deliver business value.',
    objectives: [
      'Celebrate top 100 IT organizations and visionary leaders.',
      'Unpack enterprise AI, cloud architecture, and cybersecurity trends.',
      'Network with 250+ enterprise executives, VCs, and founders.',
    ],
    speakers: [],
    sponsors: [],
    itinerary: [],
    highlights: ['CIO 100 Awards Ceremony & Gala', 'Keynotes from Fortune 500 CISOs & CIOs', 'Exclusive VIP Executive Dinner'],
    highlightCards: [],
    ...
    metadata: {
      title: 'Global CXO Circle | CIO 100 Awards & Conference 2026',
      description: 'Join top enterprise IT leaders at the annual CIO 100 Awards & Conference 2026.',
      image: sfConferenceImages.banner,
    },
    venue: {
      name: 'San Jose Convention Center',
      address: '150 W San Carlos St, San Jose, CA 95113',
      description: 'Silicon Valley premier event venue.',
      image: sfConferenceImages.card,
      mapEmbedUrl: 'https://maps.google.com/maps?q=San+Jose+Convention+Center&output=embed',
    },
  },
  {
    id: 1,
