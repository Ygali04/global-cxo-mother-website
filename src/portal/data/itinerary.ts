...
export const globalInnovationSummitItinerary: ItineraryItem[] = [
  ...
  },
  {
    ...
    description: "Recognition for Hall Of Fame legends and their contributions to the CXO community. Discussion topics include defining moments, leadership philosophy, turning challenges into legacy, and passing the torch.",
    type: "keynote",
    timeOfDay: "morning",
    moderators: ["Lenin Gali"],
  ...
  },
  {
    ...
    title: "Awards Dinner",
    description: "Recognition dinner for amazing leaders dedicated to the profession. Inducting leaders into the CXO Hall Of Fame and recognizing CXOs taking risks by introducing startups and supporting founders' vision.",
    type: "dinner",
    timeOfDay: "evening",
