                        ...
                        <div className="tgmenu__wrap">
                           <nav className="tgmenu__nav">
                              ...
                              <div className="tgmenu__action d-none d-md-block">
                               ...
                               <div className="mobile-nav-toggler" onClick={() => setSidebar(true)} aria-label="Open mobile menu" style={{ display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#0B1A4A" }}>
